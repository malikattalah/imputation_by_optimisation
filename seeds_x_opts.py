# This script generates the Optimisation imputations for the seeds dataset.
...
def run_exps():
    ...
    for i, missing_ratio in enumerate(missing_ratios):
        save_path = "data/datasets/real_world_x_opts/seeds_x_s"+str(n_samples)+"_f"+str(n_features)+"_c"+str(n_centers)+"_m-r"+str(int(missing_ratio*100))+"_m-nb"+str(int(n_samples*n_features*missing_ratio))+"_rs"+str(random_state)+".csv"
